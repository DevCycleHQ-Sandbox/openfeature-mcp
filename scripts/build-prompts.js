...
async function readPromptFile(guide) {
  ...
  try {
    ...
    console.warn(`⚠️  ${guide}: Local prompt file not found`);
    return null;
  }
}
...
export const InstallGuideSchema = z.enum(INSTALL_GUIDES);
export type InstallGuide = z.infer<typeof InstallGuideSchema>;

export const BUNDLED_PROMPTS: Record<InstallGuide, string> = {
